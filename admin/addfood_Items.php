...
<div class="container">
    <div class="container">
        ...
        <a href="./myrestaurants.php" class="list-group-item ">My Restaurant</a>
    		...
    		<a href="./addfood_Items.php" class="list-group-item active">Add Food Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="viewfood_Items.php" method="POST">
        <br style="clear: both">
          ...
          <input type="reset" id="submit" class="btn btn-primary pull-left"   value="CLEAR">
          </div>
