...
<div class="container">
    <div class="container">
        ...
        <a href="./myrestaurants.php" class="list-group-item ">My Restaurant</a>
    		...
    		<a href="./editfood_Items.php" class="list-group-item active">Edit Food Items</a>
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    while ($row = mysqli_fetch_array($query)) {
      ...
      <div class="list-group" style="text-align: center;">
        <?php
      echo "<b><a href='editfood_Items.php?update= {$row['F_ID']}'>{$row['name']}</a></b>";  
        ?>
      </div>
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="editfood_Items.php" method="GET">
        <br style="clear: both">
