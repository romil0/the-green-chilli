 ...
 <?php
    ...
    if (isset($_SESSION['login_user1'])) {
        header("location: ./myrestaurants.php"); //Redirecting to myrestaurant Page
    }
    ?>
 ...
 <body>
                 ...
                 <ul class="nav navbar-nav navbar-right">
                     <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Sign Up <span class="caret"></span> </a>
                         <ul class="dropdown-menu">
                             ...
                             <li> <a href="./managerSingup.php"> Manager Sign-up</a></li>
     ...
     <div class="container">
         <div class="jumbotron" style="background-color: transparent;">
             <h1>Hi Manager,<br> Welcome to <span class="edit"> The Green Chilli </span></h1>
             <br>
     ...
     <div class="container">
         <div class="col-md-5 col-md-offset-4" style="top: 0;">
             <label style="margin-left: 5px;color: red;"><span> <?php echo $error;  ?> </span></label>
             <div class="panel panel-primary">
                 <div class="panel-heading" style="text-align: center; font-size :larger;"> Login </div>
                 <div class="panel-body">
                     ...
                     <form action="" method="POST">
                         ...
                         <label style="margin-left: 5px;"><a href="./managerSingup.php">Create a new account.</a></label>
