...
<html>
  ...
  <link rel="stylesheet" type="text/css" href="../css/viewfoodItems.css">
...
<div class="container">
    <div class="container">
        ...
        <a href="./myrestaurants.php" class="list-group-item ">My Restaurant</a>
    		<a href="./viewfoodItems.php" class="list-group-item active">View Food Items</a>
    		...
    		<a href="./deletefood_Items.php" class="list-group-item ">Delete Food Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both;">
          <h2 style="margin-bottom: 25px; text-align: center; font-size: 30px; font-family: 'Rubik', sans-serif;"> YOUR FOOD ITEMS LIST </h2>
