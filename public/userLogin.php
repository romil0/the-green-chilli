...
<html>
  ...
  <body>
    ...
    <div class="jumbotron" style="background-color: transparent;">
     <h1>Hi Guest,<br> Welcome to <span class="edit"> The Green Chilli </span></h1>
     <br>
   <p>Kindly LOGIN to continue.</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading" style="text-align: center; font-size :xx-large;"> Login </div>
        ...
        <div class="row">
          <div class="submitButton" style="text-align: center;" >
              <button class="btn btn-primary" name="submit" type="submit" value=" Login " style="justify-content: center;">Submit</button>
          </div>

        </div>
        <label style="margin-left: 5px;">or</label> <br>
       <label style="margin-left: 5px;"><a href="./userSingup.php">Create a new account.</a></label>
